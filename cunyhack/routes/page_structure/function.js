function sumbitForm() {
	...
	var str = '';
	str =
		"<tr><td><center><button id='select' value='" +
		name +
		'\\\\//' +
		address +
		'\\\\//' +
...
function formatDate(date) {
	...
	if (
		num[1] < 1 ||
		((num[0] == 2 && num[1] > 29) ||
			((num[0] == 4 || num[0] == 6 || num[0] == 8 || num[0] == 9 || num[0] == 11) && num[1] > 30) ||
			((num[0] == 1 || num[0] == 3 || num[0] == 5 || num[0] == 7 || num[0] == 10 || num[0] == 12) && num[1] > 31))
	) {
		return true;
	}
	return false;
